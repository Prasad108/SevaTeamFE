...
export class EventService {
  ...
  updateEvent(event: Event): Observable<void> {
    ...
    return from(updateDoc(eventDocRef, { name: event.name, startDate: event.startDate, endDate: event.endDate, description: event.description , slots: event.slots})).pipe(
      map(() => {
